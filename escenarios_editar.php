  ...
  <section class="contenedor">
    <h2>Escenarios</h2>
        ...
        <div class="col-lg-12">
          ...
          <form method="POST" id="editarnombre7">
    ...
    <button type="button" onClick="location.href='Escenarios.php'"><i class="fas fa-arrow-alt-circle-left"></i></button>
    </div>
