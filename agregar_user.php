<?php
    ...
    if(!empty($_POST['name']) && !empty($_POST['password'])) {
      $sql = "INSERT INTO users (user_name, passwords) VALUES (:name, :password)";
      ...
      if($stmt->execute()){
        ...
        $message = 'Lo sentimos, no se ha podido crear el usuario. Intenta otro Nombre.';
       }
     }
 ?>
...
<body>
  ...
  <section class="seccion contenedor">
    <h2>Registro para nuevos Usuarios</h2>
