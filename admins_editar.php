...
if(isset($_GET["nombre"]) && $_GET["id"] && $_GET["password"])
  {
      $nombre = $_GET["nombre"];
      $id = $_GET["id"];
  ...
  <section class="contenedor">
    <h2>Administradores</h2>
        ...
        <div class="col-lg-12">
          ...
          <form method="POST" id="editarnombre2">
            <div class="registro caja clearfix">
              ...
              <div class="campo">   
                ...
                <input type="password" class="form-control" id="InputPassword" name="InputPassword" value="<?php echo $passwords; ?>" required>
              </div>
    ...
    <button type="button" onClick="location.href='Admins.php'"><i class="fas fa-arrow-alt-circle-left"></i></button>
    </div>
