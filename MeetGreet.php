...
<body>
  ...
  <div class="col-lg-12">
      ...
      <div class="campo"> <!--Aquì inicia el DDL Famoso-->
        <label><select name="famosoB" required>
        ...
        <label><select name="escenarioB" required>
        ...
        <label><select name="diaB" required>
        ...
        <div class="campo"> <!--Aquì inicia el DDL Dia-->
        <label><select name="horaB" required>
    ...
    <button id = "recargar6"><i class="fas fa-arrow-alt-circle-down"></i></button>
    <div class="caja">
        <div class="col-lg-12">
          <div id="obtenertodo6">
          </div>
