  ...
  <div class="barra">
    <div class="contenedor clearfix">
      ...
      <nav class="navegacion-principal clearfix">
          ...
          <a href="histmeet.php">Meet&Greet</a>
  ...
  <section class="contenedor">
    ...
    <table class="table tablasc table-striped table-bordered">
                        ...
                        while ($row = $stmt2->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT)) { ?>
                            ...
                            <td><a href="historial.php" id="<?php echo $row[0];?>" class="alert-link histdelete"><i class="fas fa-trash-alt"></i></a></td>
                            <?php $suma += $row[5]; ?> 
                        </tr>
                      <?php } ?>
                   </table>
        <h3>Total: $ <?php echo $suma; ?><h3>
        <a href="fpdf/tutorial/histpdf.php"><i class="fas fa-print"></i></a>
    </section>
  </section>
