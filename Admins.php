...
<body>
  ...
  <div class="col-lg-12">
        <h3>Añadir nuevos Administradores</h3>
      ...
      <div class="registro caja clearfix">
        ...
        <div class="campo">
            ...
            <input type="password" class="form-control" id="exampleInputPassword" name="exampleInputPassword" placeholder="Enter Password" required>
        </div>
        <div class="campo">
    ...
    <button id = "recargar2"><i class="fas fa-arrow-alt-circle-down"></i></button>
    <div class="caja">
        <div class="col-lg-12">
          <div id="obtenertodo2">
          </div>
