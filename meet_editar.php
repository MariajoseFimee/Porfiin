...
if(isset($_GET["id"]) && isset($_GET["meetnombre"]))
  {
      $id = $_GET["id"];
      $nombre = $_GET["meetnombre"];
...
<head>
  ...
  <div class="col-lg-12">
      ...
      <div class="campo"> <!--Aquì inicia el DDL Famoso-->
        <label><select name="famosoBb" required>
        ...
        <label><select name="escenarioBb" required>
        ...
        <label><select name="diaBb" required>
        ...
        <div class="campo"> <!--Aquì inicia el DDL Dia-->
        <label><select name="horaBb" required>
    ...
    <button type="button" onClick="location.href='MeetGreet.php'"><i class="fas fa-arrow-alt-circle-left"></i></button>
    </div>
