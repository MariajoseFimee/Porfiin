<?php
    ...
    require 'database.php';
     ...
     if(!empty($_POST['name']) && !empty($_POST['password'])) {
       $sql = "SELECT * FROM users WHERE user_name=:name AND passwords=:password";
       ...
       if($results != null){
          ...
          $message = 'Ups! No estas registrado o verifica tus datos.';
        }
      }
 ?>
  ...
  <div class="barra">
    <div class="contenedor clearfix">
      ...
      <nav class="navegacion-principal clearfix">
          ...
          <a href="agregar_user.php">Registro</a>
