...
if(isset($_GET["id"]) && isset($_GET["eventosnombre"]))
  {
      $id = $_GET["id"];
      $nombre = $_GET["eventosnombre"];
...
<head>
  ...
  <div class="col-lg-12">
      ...
      <div class="campo"> <!--Aquì inicia el DDL Famoso-->
        <label><select name="famosoA" required>
        ...
        <label><select name="escenarioA" required>
        ...
        <label><select name="diaA" required>
        ...
        <div class="campo">
        <button type="submit" name="boton" class="btn btn-primary">Cambiar</button>
        <p id="respuesta3"></p>
        </div>
    ...
    <button type="button" onClick="location.href='Eventos.php'"><i class="fas fa-arrow-alt-circle-left"></i></button>
    </div>
